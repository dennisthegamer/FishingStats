...
Configure everything in-game via the YACL config screen (opened through ModMenu):
...
- **Loader:** Fabric (Fabric Loader 0.18.3 or higher)
- **Fabric API:** Required
- **Java:** 21 or higher
- **ModMenu + YACL:** Recommended (for the in-game config screen)

## Installation

1. Install [Fabric Loader](https://fabricmc.net/use/)
2. Download [Fabric API](https://modrinth.com/mod/fabric-api)
3. (Recommended) Download [ModMenu](https://modrinth.com/mod/modmenu) and [YACL](https://modrinth.com/mod/yacl)
4. Download FishingStats and drop all JARs into your `mods` folder
5. Launch Minecraft
